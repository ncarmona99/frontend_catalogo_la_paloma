        ...
        <div class="form-container">
          <form @submit.prevent="saveProducto" class="product-form">
            ...
            <div class="form-section">
              ...
              <div class="form-grid">
                <div class="form-group">
                  ...
                  <select id="familia_id" v-model="formData.familia_id" class="form-select">
                ...
                <div class="form-group">
                  ...
                  <select id="marca_id" v-model="formData.marca_id" class="form-select">
                ...
                <div class="form-group">
                  ...
                  <select id="proveedor_id" v-model="formData.proveedor_id" class="form-select">
                ...
                <div class="form-group form-group-full">
                  ...
                  <div class="chips-select">
                    <div class="chips">
                      <span v-for="t in selectedTemporadasObjects" :key="t.id" class="chip">
                        {{ t.nombre }}
                        <button type="button" class="chip-remove" @click="removeTemporada(t.id)"><i class="fas fa-times"></i></button>
                      </span>
                    </div>
                    <div class="chips-actions">
                      <select v-model="tempTemporadaId" class="form-select">
                        <option value="">Agregar temporada…</option>
                        <option v-for="t in temporadas" :key="t.id" :value="t.id" :disabled="formData.temporadas.includes(t.id)">{{ t.nombre }}</option>
                      </select>
                      <button type="button" class="btn" @click="addTemporada" :disabled="!tempTemporadaId">Agregar</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="form-section">
              ...
              <div class="form-grid">
                <div class="form-group">
                  ...
                  <input 
                    id="stock_total"
                    v-model.number="formData.stock_total" 
                    type="number" 
                    class="form-input"
                    placeholder="0"
                    min="0"
                ...
                <div class="form-group">
                  ...
                  <input 
                    id="stock_ideal"
                    v-model.number="formData.stock_ideal" 
                    type="number" 
                    class="form-input"
                    placeholder="0"
                    min="0"
                ...
                <div class="form-group">
                  ...
                  <input 
                    ...
                    v-model.number="formData.unidades_por_caja" 
                    type="number" 
                    class="form-input"
                    placeholder="0"
                    min="0"
            ...
            <div class="form-section">
              ...
              <div class="form-grid">
                <div class="form-group">
                  <label for="disponible_web" class="form-label">Disponible en Web</label>
                  <div class="checkbox-group">
                    <input 
                      id="disponible_web"
                      v-model="formData.disponible_web" 
                      type="checkbox" 
                      class="form-checkbox"
                    >
                    <label for="disponible_web" class="checkbox-label">
                ...
                <div class="form-group">
                  <label for="imagen_web" class="form-label">URL de Imagen Web</label>
                  <input 
                    id="imagen_web"
                    v-model="formData.imagen_web" 
                    type="url" 
                    class="form-input"
            ...
            <div class="form-section">
              ...
              <div class="form-grid">
                ...
                <div class="form-group form-group-full">
                  ...
                  <textarea 
                    id="motivo_estado"
                    v-model="formData.motivo_estado" 
                    class="form-textarea"
  ...
  try {
    ...
    if (response.success) {
      ...
      formData.value = {
        ...
        plu: producto.value.plu || '',
        codigo_barras: producto.value.codigo_barras || '',
        descripcion: producto.value.descripcion || '',
        familia_id: producto.value.familia?.id || '',
        marca_id: producto.value.marca?.id || '',
        proveedor_id: producto.value.proveedor?.id || '',
        temporadas: (producto.value.temporadas || []).map(t => t.id),
        stock_total: producto.value.stock?.total || 0,
        stock_minimo: producto.value.stock?.minimo || 0,
        stock_ideal: producto.value.stock?.ideal || 0,
        unidades_por_caja: producto.value.stock?.unidades_por_caja || 0,
        disponible_web: producto.value.disponible_web || false,
        imagen_web: producto.value.imagen_web || '',
        zona: producto.value.zona || 0,
        estado: producto.value.estado || 'ACTIVO',
        motivo_estado: producto.value.motivo_estado || ''
      }
    }
  } catch (error) {
...
const loadProveedores = async () => {
  try {
    const response = await apiCall('/catalogo/proveedores')
    if (response.success) {
...
const loadTemporadas = async () => {
  try {
    const response = await apiCall('/admin/temporadas?pagina=1&limite=200&sortField=nombre&sortOrder=asc')
    if (response.success) {
...
function removeTemporada(id) {
  formData.value.temporadas = formData.value.temporadas.filter(tid => tid !== id)
}
...
const saveProducto = async () => {
  ...
  try {
    const data = {
      ...formData.value,
      stock: {
        total: formData.value.stock_total,
        minimo: formData.value.stock_minimo,
        ideal: formData.value.stock_ideal,
        unidades_por_caja: formData.value.unidades_por_caja
      }
    }
