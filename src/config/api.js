...
export async function apiCall(endpoint, options = {}) {
  ...
  try {
    ...
    // Devolver los datos directamente para mantener compatibilidad con el código existente
    return data;
  } catch (error) {
...
// Objeto API con métodos HTTP estándar que devuelve estructura compatible con axios
export const api = {
  // Método GET
